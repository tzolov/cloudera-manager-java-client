...
public class Event {
	...
	public enum EventCategory {
		...
		LOG_EVENT,
		/**
		 * This event was caused by an audit event e.g. service restart, role
		 * reconfiguration, etc
		 */
		AUDIT_EVENT,
		/**
		 * This event was triggered by an activity event e.g. activity entered
		 * shuffle phase, stopped, preempted, etc
		 */
		ACTIVITY_EVENT;
	}
	...
	public enum EventSeverity {
		...
		IMPORTANT,
		/**
		 * This is the most severe event and signifies an important error that
	...
	@Override
	public String toString() {
		return "Event [id=" + id + ", content=" + content + ", timeOccurred="
				+ timeOccurred + ", timeReceived=" + timeReceived
				+ ", category=" + category + ", severity=" + severity
				+ ", alert=" + alert + ", attributes=" + attributes + "]";
	}
