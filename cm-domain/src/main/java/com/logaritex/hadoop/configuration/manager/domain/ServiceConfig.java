...
public class ServiceConfig extends ConfigList {
	 ...
	 */
	private List<RoleTypeConfig> roleTypeConfigs;

	public List<RoleTypeConfig> getRoleTypeConfigs() {
		return roleTypeConfigs;
	}

	public void setRoleTypeConfigs(List<RoleTypeConfig> roleTypeConfigs) {
		this.roleTypeConfigs = roleTypeConfigs;
	}
	
	@Override
	public String toString() {
		return "ServiceConfig [roleTypeConfigs=" + roleTypeConfigs
				+ ", items=" + items + "]";
	}
}
