 ...
 * password information. The password property is only used when creating or
 * updating users.
 * 
 */
public class User {
	...
	/**
	 * Returns the user password. Passwords are not returned when querying user
	 * information, so this property will always be empty when reading
	 * information from a server.
	 */
	private String password;

	/**
	 * A list of roles this user belongs to. Current possible values are:
	 * "ROLE_ADMIN" or empty.
	 */
